 ...
 */
public interface PullProcess3o5<I1, I2, I3, O1, O2, O3, O4, O5> {
    /**
     * processes the data
     * <pre>
     * Batch.from(src1,src2,src3).into(dst).proceed((rd1,rd2,rd3,wr1,wr2,wr3,wr4,wr5) -> {
     *     val i1 = rd1.get();
     *     val i2 = rd2.get();
     *     val i3 = rd3.get();
     *     ...
     ...
     */
    void proceed(PullWorker3o5<I1, I2, I3, O1, O2, O3, O4, O5> worker);
}
