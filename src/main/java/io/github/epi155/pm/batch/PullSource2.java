...
public interface PullSource2<I1, I2> {
     ...
     * @return instance of {@link PullProcess2o1}
     */
    <T extends AutoCloseable, O> PullProcess2o1<I1, I2, O> into(SinkResource<T, O> sink);
     ...
     * @return instance of {@link PullProcess2o2}
     */
    <T1 extends AutoCloseable, O1, T2 extends AutoCloseable, O2>
    PullProcess2o2<I1, I2, O1, O2> into(SinkResource<T1, O1> sink1, SinkResource<T2, O2> sink2);
     ...
     * @return instance of {@link PullProcess2o3}
     */
     ...
     * @return instance of {@link PullProcess2o4}
     */
    <T1 extends AutoCloseable, O1,
            T2 extends AutoCloseable, O2,
            T3 extends AutoCloseable, O3,
     ...
     * @return instance of {@link PullProcess2o5}
     */
    <T1 extends AutoCloseable, O1,
            T2 extends AutoCloseable, O2,
            T3 extends AutoCloseable, O3,
     ...
     * @return instance of {@link PullProcess2o6}
     */
    <T1 extends AutoCloseable, O1,
            T2 extends AutoCloseable, O2,
            T3 extends AutoCloseable, O3,
     ...
     * @return instance of {@link PullProcess2o7}
     */
    <T1 extends AutoCloseable, O1,
            T2 extends AutoCloseable, O2,
            T3 extends AutoCloseable, O3,
     ...
     * @return instance of {@link PullProcess2o8}
     */
    <T1 extends AutoCloseable, O1,
            T2 extends AutoCloseable, O2,
            T3 extends AutoCloseable, O3,
