...
public interface ParallelLoop5<I, O1, O2, O3, O4, O5> {
     ...
     *
     * @param maxThread        maximum number of parallel processing
     * @param asyncTransformer asynchronous function that transforms input into {@link Tuple5} outputs
     */
    void forEachAsync(int maxThread,
                      Function<? super I,
                              ? extends Future<? extends Tuple5<
                                      ? extends O1,
                                      ? extends O2,
                                      ? extends O3,
                                      ? extends O4,
                                      ? extends O5>>> asyncTransformer);
     ...
     */
    void forEachAsync(int maxThread, AsyncWorker5<? super I,
            Consumer<? super O1>,
            Consumer<? super O2>,
            Consumer<? super O3>,
            Consumer<? super O4>,
