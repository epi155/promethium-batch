...
public interface OnSuccess {
     ...
     * @return instance of {@link KeepStatus}
     */
    <P, C extends StepCount> KeepStatus onSuccess(P p, C c, BiFunction<P, C, Integer> pgm);
     ...
     * @return instance of {@link KeepStatus}
     */
    <C extends StepCount> KeepStatus onSuccess(C c, ToIntFunction<C> pgm);
     ...
     * @return instance of {@link KeepStatus}
     */
    <P, C extends StepCount> KeepStatus onSuccess(P p, C c, BiConsumer<P, C> pgm);
     ...
     * @return instance of {@link KeepStatus}
     */
    <C extends StepCount> KeepStatus onSuccess(C c, Consumer<C> pgm);
}
