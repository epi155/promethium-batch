 ...
 */
public interface ParallelLoop6<I, O1, O2, O3, O4, O5, O6> {
    /**
     ...
     */
    void forEachParallel(int maxThread, Worker6<? super I,
            Consumer<? super O1>,
            Consumer<? super O2>,
            Consumer<? super O3>,
            Consumer<? super O4>,
     ...
     *
     * @param maxThread   maximum number of parallel processing
     * @param transformer function that transforms input into {@link Tuple6} outputs
     */
    void forEachParallelFair(int maxThread, Function<? super I, ? extends Tuple6<
            ? extends O1,
            ? extends O2,
            ? extends O3,
            ? extends O4,
     ...
     * @param transformer function that transforms input into {@link Tuple6} outputs
     */
    void forEachParallel(int maxThread, Function<? super I, ? extends Tuple6<
            ? extends O1,
            ? extends O2,
            ? extends O3,
            ? extends O4,
     ...
     *
     * @param maxThread        maximum number of parallel processing
     * @param asyncTransformer asynchronous function that transforms input into {@link Tuple6} outputs
     */
    void forEachAsync(int maxThread,
                      Function<? super I,
                              ? extends Future<? extends Tuple6<
                                      ? extends O1,
                                      ? extends O2,
                                      ? extends O3,
                                      ? extends O4,
                                      ? extends O5,
                                      ? extends O6>>> asyncTransformer);
     ...
     */
    void forEachAsync(int maxThread, AsyncWorker6<? super I,
            Consumer<? super O1>,
            Consumer<? super O2>,
            Consumer<? super O3>,
            Consumer<? super O4>,
