...
public interface NextPgm {
     ...
     */
    <P, C extends StepCount> StepStatus nextPgm(P p, C c, BiFunction<P, C, Integer> pgm);
     ...
     * @return instance of {@link StepStatus}
     */
    <C extends StepCount> StepStatus nextPgm(C c, ToIntFunction<C> pgm);
     ...
     * @return instance of {@link StepStatus}
     */
    <P, C extends StepCount> StepStatus nextPgm(P p, C c, BiConsumer<P, C> pgm);
     ...
     * @return instance of {@link StepStatus}
     */
    <C extends StepCount> StepStatus nextPgm(C c, Consumer<C> pgm);
}
